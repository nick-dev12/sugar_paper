<?php
/**
 * Migration: section accueil « decoration_gateau » sur produits
 * Exécuter: php migrations/run_add_produits_section_decoration_gateau.php
 */
...
try {
    ...
    echo "Valeur decoration_gateau ajoutee a section_accueil.\n";
