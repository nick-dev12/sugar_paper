<?php
/**
 * Migration: section accueil « disques_cocktail » sur produits
 * Exécuter: php migrations/run_add_produits_section_disques_cocktail.php
 */
...
try {
    ...
    echo "Valeur disques_cocktail ajoutee a section_accueil.\n";
