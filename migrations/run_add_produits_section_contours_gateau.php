<?php
/**
 * Migration: section accueil « contours_gateau » sur produits
 * Exécuter: php migrations/run_add_produits_section_contours_gateau.php
 */
...
try {
    ...
    echo "Valeur contours_gateau ajoutee a section_accueil.\n";
