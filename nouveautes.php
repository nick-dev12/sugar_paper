...
<head>
    ...
    <style>
        ...
        .empty-state a {
            ...
            background: var(--couleur-dominante); color: #fff; text-decoration: none;
            border-radius: 8px; font-weight: 600; transition: all 0.3s;
        }
        .empty-state a:hover { background: rgba(229, 72, 138, 0.9); }
        ...
        .pagination a:hover { background: var(--couleur-dominante); color: #fff; border-color: var(--couleur-dominante); }
        .pagination .current { background: var(--couleur-dominante); color: #fff; border-color: var(--couleur-dominante); }
    </style>
</head>
<body>
