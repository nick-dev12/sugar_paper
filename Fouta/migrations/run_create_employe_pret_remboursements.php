<?php
/**
 * php migrations/run_create_employe_pret_remboursements.php
 */
require_once __DIR__ . '/../conn/conn.php';

$sql = file_get_contents(__DIR__ . '/create_employe_pret_remboursements_table.sql');
...
echo "Terminé — table employe_pret_remboursements.\n";
