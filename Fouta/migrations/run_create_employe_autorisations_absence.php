<?php
/**
 * php migrations/run_create_employe_autorisations_absence.php
 */
require_once __DIR__ . '/../conn/conn.php';

$sql = file_get_contents(__DIR__ . '/create_employe_autorisations_absence_table.sql');
...
echo "Terminé — table employe_autorisations_absence.\n";
