...
class FCMService {
  ...
  static Future<void> initializeLocalNotifications() async {
    ...
    if (!kIsWeb && Platform.isAndroid) {
      const androidChannel = AndroidNotificationChannel(
        ...
        'FOUTA POIDS LOURDS',
        description:
            'Commandes et messages liés à votre compte FOUTA POIDS LOURDS',
  ...
  static String getTokenRegistrationScript(String token) {
    final serverUrl = _serverUrl ?? 'https://www.e.foutapoidslourds.com';
  ...
  static Future<void> _showLocalNotification(RemoteMessage message) async {
    ...
    final title = message.notification?.title ?? 'FOUTA POIDS LOURDS';
    ...
    const androidDetails = AndroidNotificationDetails(
      'fouta_pl_channel',
      'FOUTA POIDS LOURDS',
      channelDescription: 'Notifications FOUTA POIDS LOURDS',
      importance: Importance.high,
