...
<body>
    ...
    <div class="produits-visites-page">
        <div class="produits-visites-header">
            ...
            <p>Historique de vos consultations (<?php echo count($produits_visites); ?> produit<?php echo count($produits_visites) > 1 ? 's' : ''; ?>)</p>
        </div>
            ...
            <section class="produit_vedetes">
                <article class="articles carousel11">
                    ...
                    <div class="carousel" data-produit-id="<?php echo $produit['id']; ?>">
                        <span class="date-visite-badge" title="Consulté le <?php echo date('d/m/Y à H:i', strtotime($produit['date_visite'])); ?>">
