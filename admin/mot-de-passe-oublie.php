...
$emailjs_template_id = $emailjs_config['template_id'] ?? 'VOTRE_TEMPLATE_ID';
?>
<!DOCTYPE html>
<html lang="fr">
                ...
                <script>
                    (function() {
                        ...
                        if (publicKey === 'VOTRE_PUBLIC_KEY' || serviceId === 'VOTRE_SERVICE_ID' || templateId === 'VOTRE_TEMPLATE_ID') {
                            ...
                            document.getElementById('emailErrorText').textContent = 'EmailJS non configuré. Configurez emailjs_public_key, emailjs_service_id et emailjs_template_id dans mot-de-passe-oublie.php. Voir https://www.emailjs.com/';
                        } else {
                            emailjs.init(publicKey);
                            // Variables envoyées : to_email (obligatoire pour To Email), user_email, email (alias)
