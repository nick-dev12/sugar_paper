        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <small style="color: #666; font-size: 12px; display: block; margin-top: 5px;">Saisissez un poids puis cliquez sur « Ajouter ». Vous pouvez ajouter plusieurs poids.</small>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <small style="color: #666; font-size: 12px; display: block; margin-top: 5px;">Saisissez une taille puis cliquez sur « Ajouter ». Vous pouvez ajouter plusieurs tailles.</small>
                </div>
            </div>
