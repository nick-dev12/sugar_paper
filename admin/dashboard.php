    ...
    <div class="contents-container">
        <div class="content-header">
            ...
            <div class="header-actions">
                <button type="button" id="btn-enable-notifications" class="btn-primary btn-secondary-style btn-enable-notifications">
                    <i class="fas fa-bell-slash"></i> Activer les notifications
                </button>
                <a href="firebase-api-key-fix.php" class="btn-primary btn-secondary-style" title="En cas d'erreur API key">
                    <i class="fas fa-question-circle"></i> Erreur API key ?
                </a>
                <a href="test-notification.php" class="btn-primary btn-secondary-style">
                    <i class="fas fa-paper-plane"></i> Tester les notifications
                </a>
                <a href="firebase-config-check.php" class="btn-primary btn-secondary-style" title="En cas d'erreur API key">
                    <i class="fas fa-key"></i> Config Firebase
                </a>
                <a href="commandes/index.php" class="btn-primary btn-secondary-style">
                    <i class="fas fa-shopping-bag"></i> Voir les Commandes
                </a>
                <a href="commandes-personnalisees/index.php" class="btn-primary btn-secondary-style">
                    <i class="fas fa-palette"></i> Commandes personnalisées
                </a>
            ...
            if (btn) {
                btn.addEventListener('click', function() {
                    if (typeof FirebaseNotifications !== 'undefined') {
                        ...
                        alert('Erreur: Les scripts de notification ne sont pas chargés. Vérifiez la console (F12).');
                    }
                });
            }
        });
