<?php
/**
 * Crée les tables super_admin et super_admin_logs si absentes.
 * Exécuter: php migrations/run_super_admin_tables.php
 */
...
try {
    ...
    $db->exec("
        CREATE TABLE IF NOT EXISTS `super_admin_logs` (
          ...
          `cible_type` VARCHAR(60) NULL DEFAULT NULL,
    ...
    ");
    echo "Table super_admin_logs OK.\n";
