...
if (!isset($_SESSION['user_id'])) {
    header('Location: /choix-connexion.php?redirect=' . rawurlencode(boutique_url('panier.php', BOUTIQUE_SLUG)));
    exit;
}

// Panier limité à cette boutique (même compte client peut avoir d'autres lignes ailleurs)
$panier_items = get_panier_by_user($_SESSION['user_id']);
$panier_items = filter_panier_items_by_vendeur($panier_items, BOUTIQUE_ADMIN_ID);
...
<head>
    ...
    <title>Mon Panier<?php echo BOUTIQUE_NOM !== '' ? ' — ' . htmlspecialchars(BOUTIQUE_NOM) : ''; ?> - COLObanes</title>
    ...
    <div class="panier-container">
        ...
        <?php if (empty($panier_items)): ?>
            <div class="panier-empty">
                ...
                <a href="<?php echo htmlspecialchars(boutique_url('index.php', BOUTIQUE_SLUG)); ?>" class="btn-continuer">
            ...
            <div class="panier-content">
                ...
                <div class="panier-items">
                    ...
                    <div class="panier-vendeur-block">
                        <?php $show_vendor = (count($panier_groups) > 1 || !empty($g['slug'])); ?>
                        <?php if ($show_vendor): ?>
                ...
                <div class="panier-summary">
                    ...
                    <a href="<?php echo htmlspecialchars('/commande.php?boutique=' . rawurlencode(BOUTIQUE_SLUG), ENT_QUOTES, 'UTF-8'); ?>" class="btn-commander">
                        <i class="fas fa-shopping-bag"></i> Passer la commande
                    </a>

                    <a href="<?php echo htmlspecialchars(boutique_url('index.php', BOUTIQUE_SLUG)); ?>" class="link-continuer">
                        Continuer mes achats
                    </a>
                </div>
            </div>
