...
<head>
    ...
    .btn-delete:hover {
        background: rgba(32, 197, 199, 0.9);
    }
    ...
    .panier-prix-label { font-size: 16px; color: var(--texte-fonce); }
    .panier-prix-value { font-size: 20px; font-weight: 700; color: var(--titres); }
    .panier-prix-barré { font-size: 14px; color: #737373; text-decoration: line-through; margin-left: 10px; }
    .panier-update-form { display: flex; align-items: center; gap: 10px; }
    .panier-quantite-label { font-size: 14px; font-weight: 600; color: var(--texte-fonce); }
    .panier-total-detail { font-size: 14px; color: #737373; margin-bottom: 4px; }
    .panier-total-montant { font-size: 18px; font-weight: 700; color: var(--accent-promo); }
    .panier-stock-info { font-size: 12px; color: #737373; margin-top: 10px; }
    .summary-value { font-weight: 600; color: var(--titres); }
    .summary-value-alt { font-weight: 600; color: var(--couleur-dominante); }
    .summary-subtotal { margin-top: 20px; padding-top: 15px; border-top: 1px solid rgba(229, 72, 138, 0.2); }
    .summary-livraison { color: #737373; }
    .summary-total-value { color: var(--titres); }
