...
<style>
    ...
    .nav-search-suggest__item:hover,
    .nav-search-suggest__item.is-active {
        background: rgba(145, 138, 68, 0.12);
    }

    .nav-search-suggest__thumb {
        flex-shrink: 0;
        width: 40px;
        height: 40px;
        border-radius: 8px;
    ...
    .nav-search-suggest__thumb img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    }

    .nav-search-suggest__thumb--empty {
        color: #918a44;
        font-size: 16px;
    }

    .nav-search-suggest__nom {
        flex: 1;
        min-width: 0;
        font-size: 14px;
        line-height: 1.35;
...
<nav class="nav-planete-gateau">
    ...
    <div class="nav-search-wrapper">
        <form class="nav-search-form" action="/produits.php" method="get" id="nav-search-form">
            ...
            <input type="search" name="recherche" id="nav-search" class="nav-search-input"
                placeholder="Que recherchez-vous ?"
                autocomplete="off" autocorrect="off" spellcheck="false"
                role="combobox" aria-autocomplete="list" aria-controls="nav-search-suggest" aria-expanded="false"
...
<script src="/js/nav-produit-search.js?v=<?php echo htmlspecialchars($asset_version); ?>"></script>
