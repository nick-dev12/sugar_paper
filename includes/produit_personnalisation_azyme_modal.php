<?php
/**
 * Fragment HTML du modal personnalisation (inclus par render_produit_personnalisation_azyme_modal)
 */
?>
<div class="perso-modal perso-modal--azyme" id="modal-personnalisation-azyme" aria-hidden="true" role="dialog" aria-labelledby="azyme-perso-modal-title">
    <div class="perso-modal-backdrop" aria-hidden="true"></div>
    <div class="perso-modal-dialog">
        <button type="button" class="perso-modal-close" id="azyme-perso-modal-close" aria-label="Fermer">&times;</button>
        <h2 class="perso-modal-title" id="azyme-perso-modal-title">Personnalisez votre habillage papier azyme</h2>
        ...
        <div class="perso-modal-layout">
            <aside class="perso-toolbar" aria-label="Outils de personnalisation">
                <section class="perso-tool-section">
                    ...
                    <label class="perso-upload-compact" id="azyme-perso-upload-label" tabindex="0">
                        <input type="file" id="azyme-perso-image-input" accept="image/jpeg,image/png,image/webp,image/gif">
                        ...
                        <span class="perso-upload-filename" id="azyme-perso-upload-filename"></span>
                    </label>
                    <p class="perso-image-hint" id="azyme-perso-image-hint" hidden>Glissez l'image sur l'aperçu pour la repositionner. Molette ou pincement pour zoomer.</p>
                    <button type="button" class="perso-image-reset-btn" id="azyme-perso-image-reset" hidden>Réinitialiser le cadrage</button>
                </section>

                <section class="perso-tool-section">
                    <h3 class="perso-tool-title"><i class="fa-solid fa-file" aria-hidden="true"></i> Format de feuille</h3>
                    <p class="perso-paper-info" id="azyme-perso-paper-info">Feuille A4 — 21 × 29,7 cm</p>
                    <p class="perso-field-hint">Format fixe A4 pour l’habillage papier azyme.</p>
                </section>
                ...
                <section class="perso-tool-section">
                    ...
                    <div class="perso-dimension-field" id="azyme-perso-dim-width-wrap">
                        <label for="azyme-perso-dim-width">Largeur <span id="azyme-perso-dim-width-val">15</span> cm</label>
                        <input type="range" id="azyme-perso-dim-width" min="5" max="19" step="0.5" value="15">
                    </div>
                    <div class="perso-dimension-field" id="azyme-perso-dim-height-wrap">
                        <label for="azyme-perso-dim-height">Hauteur <span id="azyme-perso-dim-height-val">15</span> cm</label>
                        <input type="range" id="azyme-perso-dim-height" min="5" max="27.7" step="0.5" value="15">
                    </div>
                    <div class="perso-dimension-field" id="azyme-perso-dim-diameter-wrap" hidden>
                        <label for="azyme-perso-dim-diameter">Diamètre <span id="azyme-perso-dim-diameter-val">15</span> cm</label>
                        <input type="range" id="azyme-perso-dim-diameter" min="5" max="19" step="0.5" value="15">
                    </div>
                </section>

                <section class="perso-tool-section">
                    <h3 class="perso-tool-title"><i class="fa-solid fa-font" aria-hidden="true"></i> Texte</h3>
                    <div class="perso-text-list" id="azyme-perso-text-list" role="list" aria-label="Textes ajoutés"></div>
                    <button type="button" class="perso-text-add-btn" id="azyme-perso-text-add"><i class="fa-solid fa-plus" aria-hidden="true"></i> Ajouter un texte</button>
                    <textarea class="perso-text-input" id="azyme-perso-text-input" maxlength="500" rows="3" placeholder="Votre texte ici… (Entrée = retour à la ligne)" autocomplete="off"></textarea>

                    <div class="perso-text-controls">
                        <div class="perso-dimension-field">
                            <label for="azyme-perso-text-size"><span class="perso-dim-label-text">Taille du texte</span> <span id="azyme-perso-text-size-val">50</span>%</label>
                            <input type="range" id="azyme-perso-text-size" min="20" max="100" value="50" step="1">
                        </div>
                        <div class="perso-dimension-field">
                            <label for="azyme-perso-text-pos-x"><span class="perso-dim-label-text">Position horizontale</span> <span id="azyme-perso-text-pos-x-val">50</span>%</label>
                            <input type="range" id="azyme-perso-text-pos-x" min="0" max="100" value="50" step="1">
                        </div>
                        <div class="perso-dimension-field">
                            <label for="azyme-perso-text-pos-y"><span class="perso-dim-label-text">Position verticale</span> <span id="azyme-perso-text-pos-y-val">50</span>%</label>
                            <input type="range" id="azyme-perso-text-pos-y" min="0" max="100" value="50" step="1">
                        </div>
                        <div class="perso-dimension-field" id="azyme-perso-text-rotation-wrap">
                            <label for="azyme-perso-text-rotation"><span class="perso-dim-label-text">Orientation</span> <span id="azyme-perso-text-rotation-val">0</span>°</label>
                            <input type="range" id="azyme-perso-text-rotation" min="-180" max="180" value="0" step="1">
                        </div>
                        <div class="perso-color-field">
                            ...
                            <div class="perso-color-picker" role="group" aria-label="Couleur du texte">
                                ...
                                <label class="perso-color-custom" title="Couleur personnalisée">
                                    <input type="color" id="azyme-perso-text-color" value="#E5488A">
                                    <span><i class="fa-solid fa-eyedropper" aria-hidden="true"></i></span>
                                </label>
                            </div>
                        </div>
                        <div class="perso-wrap-toggle">
                            <input type="checkbox" id="azyme-perso-text-wrap-circle" class="perso-wrap-checkbox">
                            <button type="button" class="perso-wrap-btn" id="azyme-perso-wrap-circle-btn" aria-pressed="false">
                                <span class="perso-checkbox-box" aria-hidden="true"></span>
                                <span class="perso-checkbox-text">Épouser la forme du cercle</span>
                            </button>
                        </div>
                        <div class="perso-wrap-position" id="azyme-perso-wrap-position" role="group" aria-label="Position du texte sur le cercle">
            ...
            <div class="perso-preview-panel">
                ...
                <div class="perso-preview-stage">
                    <div class="perso-preview-viewport" id="azyme-perso-preview-viewport">
                        <canvas id="azyme-perso-preview-canvas" width="640" height="640" aria-label="Aperçu de la personnalisation"></canvas>
                        <div class="perso-image-manipulator" id="azyme-perso-image-manipulator" hidden aria-hidden="true">
                            <div class="perso-image-manip-box" id="azyme-perso-image-manip-box">
                                <button type="button" class="perso-manip-delete" id="azyme-perso-image-delete" aria-label="Supprimer l'image">&times;</button>
                        ...
                        <div class="perso-text-manipulator" id="azyme-perso-text-manipulator" hidden aria-hidden="true">
                            <div class="perso-text-manip-box" id="azyme-perso-text-manip-box">
                                <button type="button" class="perso-manip-delete" id="azyme-perso-text-delete" aria-label="Supprimer ce texte">&times;</button>
        ...
        <p class="perso-loading" id="azyme-perso-loading" hidden>Préparation de l'image…</p>

        <div class="perso-modal-actions">
            <button type="button" class="perso-btn perso-btn-secondary" id="azyme-perso-cancel">Annuler</button>
            <button type="button" class="perso-btn perso-btn-primary" id="azyme-perso-validate" disabled>Valider et ajouter au panier</button>
        </div>
    </div>
</div>
