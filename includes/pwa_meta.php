...
<script>(function(){try{var m=document.querySelector('meta[name="viewport"]');if(m){var c=m.getAttribute('content')||'';if(c.indexOf('viewport-fit')===-1){c+=(c? ', ':'')+'viewport-fit=cover';}var n=(window.__SUGARPAPER_NATIVE_APP===true)||(/SugarPaperApp/i.test(navigator.userAgent||''));if(n&&c.indexOf('interactive-widget')===-1){c+=(c? ', ':'')+'interactive-widget=overlays-content';}m.setAttribute('content',c);if(n){document.documentElement.classList.add('is-native-app');}}else{var n=(window.__SUGARPAPER_NATIVE_APP===true)||(/SugarPaperApp/i.test(navigator.userAgent||''));if(n){document.documentElement.classList.add('is-native-app');}}}catch(e){}})();</script>
