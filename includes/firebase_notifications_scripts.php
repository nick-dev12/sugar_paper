...
<script src="https://www.gstatic.com/firebasejs/12.9.0/firebase-messaging-compat.js" defer></script>
...
<script src="/js/firebase-notifications.js?v=<?php echo htmlspecialchars($firebase_js_v, ENT_QUOTES, 'UTF-8'); ?>" defer></script>
<?php
