        ...
        <header class="er-carte-rh__head">
            <div class="er-carte-rh__mark" title="Logo">
                <?php if (!empty($carte_logo_url)): ?>
                    <img src="<?php echo htmlspecialchars((string) $carte_logo_url); ?>" alt="Logo Sugar Paper" width="90" height="90" decoding="async">
                <?php else: ?>
                    <i class="fas fa-building" aria-hidden="true"></i>
                <?php endif; ?>
            </div>
            <div class="er-carte-rh__head-center">
                <p class="er-carte-rh__brand">Sugar Paper</p>
