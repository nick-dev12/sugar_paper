...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .facture-logo { width: 100px; height: 100px; border: 2px solid #e5488a; border-radius: 50%; overflow: hidden; flex-shrink: 0; }
        ...
        .facture-meta .solde { font-size: 16px; color: #e5488a; margin-top: 8px; }
        ...
        .facture-summary .total { font-weight: 700; font-size: 16px; padding-top: 12px; border-top: 2px solid #e5488a; margin-top: 8px; }
        ...
        <div class="facture-header">
            <div class="facture-entreprise">
                <div class="facture-logo">
                    <img src="/image/sugar_paper.jpg" alt="Sugar Paper" onerror="this.style.background='#fef5f9'">
                </div>
