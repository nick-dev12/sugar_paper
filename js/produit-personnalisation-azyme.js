/**
 * Personnalisation habillage papier azyme — format A4 uniquement, export canvas
 */
(function () {
    'use strict';

    var modal = document.getElementById('modal-personnalisation-azyme');
    if (!modal) {
        return;
    }
    ...
    var btnClose = document.getElementById('azyme-perso-modal-close');
    var btnCancel = document.getElementById('azyme-perso-cancel');
    var btnValidate = document.getElementById('azyme-perso-validate');
    var fileInput = document.getElementById('azyme-perso-image-input');
    var uploadLabel = document.getElementById('azyme-perso-upload-label');
    var filenameEl = document.getElementById('azyme-perso-upload-filename');
    var canvas = document.getElementById('azyme-perso-preview-canvas');
    var previewViewport = document.getElementById('azyme-perso-preview-viewport');
    var textManipulator = document.getElementById('azyme-perso-text-manipulator');
    var textManipBox = document.getElementById('azyme-perso-text-manip-box');
    var imageManipulator = document.getElementById('azyme-perso-image-manipulator');
    var imageManipBox = document.getElementById('azyme-perso-image-manip-box');
    var imageHintEl = document.getElementById('azyme-perso-image-hint');
    var imageResetBtn = document.getElementById('azyme-perso-image-reset');
    var imageDeleteBtn = document.getElementById('azyme-perso-image-delete');
    var textDeleteBtn = document.getElementById('azyme-perso-text-delete');
    var textInput = document.getElementById('azyme-perso-text-input');
    var textListEl = document.getElementById('azyme-perso-text-list');
    var textAddBtn = document.getElementById('azyme-perso-text-add');
    var dimWidth = document.getElementById('azyme-perso-dim-width');
    var dimHeight = document.getElementById('azyme-perso-dim-height');
    var dimDiameter = document.getElementById('azyme-perso-dim-diameter');
    var dimWidthVal = document.getElementById('azyme-perso-dim-width-val');
    var dimHeightVal = document.getElementById('azyme-perso-dim-height-val');
    var dimDiameterVal = document.getElementById('azyme-perso-dim-diameter-val');
    var dimWidthWrap = document.getElementById('azyme-perso-dim-width-wrap');
    var dimHeightWrap = document.getElementById('azyme-perso-dim-height-wrap');
    var dimDiameterWrap = document.getElementById('azyme-perso-dim-diameter-wrap');
    var paperInfoEl = document.getElementById('azyme-perso-paper-info');
    var paperBtns = [];
    var shapeBtns = modal.querySelectorAll('.perso-shape-btn');
    var textSize = document.getElementById('azyme-perso-text-size');
    var textSizeVal = document.getElementById('azyme-perso-text-size-val');
    var textPosX = document.getElementById('azyme-perso-text-pos-x');
    var textPosXVal = document.getElementById('azyme-perso-text-pos-x-val');
    var textPosY = document.getElementById('azyme-perso-text-pos-y');
    var textPosYVal = document.getElementById('azyme-perso-text-pos-y-val');
    var textRotation = document.getElementById('azyme-perso-text-rotation');
    var textRotationVal = document.getElementById('azyme-perso-text-rotation-val');
    var textWrapCircle = document.getElementById('azyme-perso-text-wrap-circle');
    var wrapCircleBtn = document.getElementById('azyme-perso-wrap-circle-btn');
    var wrapCircleHint = document.getElementById('azyme-perso-wrap-circle-hint');
    var wrapPosBtns = modal.querySelectorAll('.perso-wrap-pos-btn');
    var textColorInput = document.getElementById('azyme-perso-text-color');
        ...
        if (modal) {
            modal.addEventListener('pointerdown', function (event) {
                ...
                if (event.target.closest(
                    '#azyme-perso-preview-canvas, .perso-text-manipulator, .perso-image-manipulator, ' +
    ...
    function getFormContext(form) {
        if (!form) {
            return {
                ...
                btnOpen: document.getElementById('btn-personnaliser-azyme')
            };
        }
        ...
        return {
            ...
            statusBox: document.getElementById('perso-status'),
            statusThumb: document.getElementById('perso-status-thumb'),
            btnOpen: form.querySelector('.js-open-azyme-perso-modal') || document.getElementById('btn-personnaliser-azyme')
        };
    }
    ...
    function canvasToFile(callback) {
        ...
        canvas.toBlob(function (blob) {
            ...
            callback(new File([blob], 'personnalisation-azyme.png', { type: 'image/png' }));
        }, 'image/png', 0.92);
    }
    ...
    document.addEventListener('click', function (event) {
        var openBtn = event.target.closest('.js-open-azyme-perso-modal, #btn-personnaliser-azyme');
        if (openBtn) {
            event.preventDefault();
