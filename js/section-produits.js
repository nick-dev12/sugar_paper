...
(function () {
  ...
  function chargerPlusProduits(grid) {
    ...
    fetch('api/get_produits_section.php?section=' + encodeURIComponent(sectionKey) + '&offset=' + offsetActuel + '&limit=' + limit + '&rand_seed=' + encodeURIComponent(grid.getAttribute('data-rand-seed') || ''))
